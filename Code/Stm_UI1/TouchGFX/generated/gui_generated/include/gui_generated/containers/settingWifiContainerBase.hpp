...
/*********************************************************************************/
#ifndef SETTINGWIFICONTAINERBASE_HPP
#define SETTINGWIFICONTAINERBASE_HPP
...
class settingWifiContainerBase : public touchgfx::Container
{
public:
    settingWifiContainerBase();
    virtual ~settingWifiContainerBase();
...
protected:
    ...
    touchgfx::TextAreaWithOneWildcard wifiName;
     ...
     * Wildcard Buffers
     */
    static const uint16_t WIFINAME_SIZE = 20;
    touchgfx::Unicode::UnicodeChar wifiNameBuffer[WIFINAME_SIZE];

private:

};

#endif // SETTINGWIFICONTAINERBASE_HPP
