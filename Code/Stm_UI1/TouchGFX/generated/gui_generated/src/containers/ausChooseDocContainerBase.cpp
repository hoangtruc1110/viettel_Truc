...
ausChooseDocContainerBase::ausChooseDocContainerBase()
{
    setWidth(194);
    setHeight(86);
    ...
    tagName.setPosition(36, 26, 123, 31);
    tagName.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    tagName.setLinespacing(0);
    Unicode::snprintf(tagNameBuffer, TAGNAME_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_ZXSY).getText());
    tagName.setWildcard(tagNameBuffer);
    tagName.setTypedText(touchgfx::TypedText(T___SINGLEUSE_7G1H));
    add(tagName);

    image1.setXY(21, 31);
    image1.setBitmap(touchgfx::Bitmap(BITMAP_CHECK_CIRCLE_ID));
...
void ausChooseDocContainerBase::initialize()
{
