...
settingItemContainerBase::settingItemContainerBase()
{
    setWidth(199);
    setHeight(54);
    ...
    settingIcon.setXY(12, 16);
    settingIcon.setBitmap(touchgfx::Bitmap(BITMAP_USER_LINE_ID));
    add(settingIcon);

    settingName.setXY(41, 18);
    settingName.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    settingName.setLinespacing(0);
    Unicode::snprintf(settingNameBuffer, SETTINGNAME_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_9IF0).getText());
    settingName.setWildcard(settingNameBuffer);
    settingName.resizeToCurrentText();
    settingName.setTypedText(touchgfx::TypedText(T___SINGLEUSE_LUYB));
    add(settingName);

    image2.setXY(162, 16);
    image2.setBitmap(touchgfx::Bitmap(BITMAP_ARROW_ID));
    add(image2);
...
void settingItemContainerBase::initialize()
{
